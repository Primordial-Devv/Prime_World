...
Config.UseTarget = 'ox_target'          -- Choose between 'qb-target', 'ox_target' or 'none' disabled!
...
Config.EnableScreenPed = true                 -- Disable the zoom pad and put it on your screen
